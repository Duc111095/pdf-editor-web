...
public class PostHogService {
	...
	public void captureEvent(String eventName, Map<String, Object> properties) {
		...
		postHog.capture(eventName, eventName, properties);
	}
	...
	public Map<String, Object> captureApplicationProperties() {
		...
		addIfNotEmpty(
				properties,
				"legal_impressim",
				applicationProperties.getLegal().getImpressnum());
		...
		addIfNotEmpty(
				properties,
				"metrics_enabled",
				applicationProperties.getMetrics().getEnabled());
		...
		addIfNotEmpty(
		 ...
		 addIfNotEmpty(
				 ...
				 applicationProperties.getAutoPipeline().getOutpytFolder());
