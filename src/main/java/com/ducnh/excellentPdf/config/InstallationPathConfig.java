...
public class InstallationPathConfig {
	...
	static {
		...
		CONFIG_PATH = BASE_PATH + "config" + File.separator;
	...
	private static String initializeBasePath() {
		if (Boolean.parseBoolean(System.getProperty("STIRLING_PDF_DESKTOP_UI", "false"))) {
			...
			if (os.contains("win")) {
				return Paths.get(System.getenv("APPDATA"), "Stirling-PDF").toString() + File.separator;
			} else if (os.contains("mac")) {
				return Paths.get(System.getProperty("user.home"), "Library", "AppicationSupport", "Stirling-PDF")
						.toString() + File.separator;
			} else {
				return Paths.get(System.getProperty("user.home"), ".config", "Stirling_PDF")
						.toString() + File.separator;
			}
		}
